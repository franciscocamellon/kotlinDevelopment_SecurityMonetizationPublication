...
import com.camelloncase.testedeperformance03.ui.recipes.SurveyViewModel
...
class SurveyManagementActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submitButton.setOnClickListener {
            ...
            val recipeName = businessNameEdt.text.toString()
            val recipeStyle = neighborhoodNameEdt.text.toString()

            when (actionType) {
                "Edit" -> fillFormToEditSurveyItem(recipeName, recipeStyle)
                else -> getCurrentDateAndStartSurvey(recipeName, recipeStyle)
            }
...
//            viewModel.updateSurvey(updatedSurvey)
    ...
    private fun startSurveyActivity(businessName: String, neighborhoodName: String, currentDate: String) {
        ...
        val intent = Intent(this@SurveyManagementActivity, SurveyManagementActivity::class.java)
